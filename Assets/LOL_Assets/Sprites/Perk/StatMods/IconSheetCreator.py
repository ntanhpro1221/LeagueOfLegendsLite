...
if not image_paths:
    print("Không có ảnh PNG nào kích thước 15x15 được tìm thấy.")
    exit()
...
print(f"Đã ghép {num_images} ảnh 15x15 thành sprite_sheet.png ({columns} cột, {rows} hàng)")
