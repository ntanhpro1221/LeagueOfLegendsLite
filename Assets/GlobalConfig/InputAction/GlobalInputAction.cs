...
//     version 1.13.1
//     from Assets/GlobalConfig/InputAction/GlobalInputAction.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/GlobalConfig/InputAction/GlobalInputAction.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @GlobalInputAction: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ~@GlobalInputAction()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, GlobalInputAction.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, GlobalInputAction.UI.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_InGame.enabled, "This will cause a leak and performance issues, GlobalInputAction.InGame.Disable() has not been called.");
    }
    ...
    public struct PlayerActions
    {
        ...
        /// </summary>
        public PlayerActions(@GlobalInputAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@GlobalInputAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
