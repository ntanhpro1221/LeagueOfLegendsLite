...
public abstract class HorizontalOrVerticalLayoutGroupWithRatio : LayoutGroup {
        ...
        if (!controlSize) {
            ...
            min = ratio?.aspectMode switch {
                AspectRatioFitterLayoutElement.AspectMode.HeightControlsWidth =>
                    axis == 0 
                    ? child.rect.width 
                    : rectTransform.rect.height - ratio.VerticalPadding - padding.vertical,
                AspectRatioFitterLayoutElement.AspectMode.WidthControlsHeight =>
                    axis == 1 
                    ? child.rect.height 
                    : rectTransform.rect.width - ratio.HorizontalPadding - padding.horizontal,
...
#if UNITY_EDITOR
    [CustomEditor(typeof(HorizontalOrVerticalLayoutGroupWithRatio), true)]
    ...
    /// </summary>
    public class HorizontalOrVerticalLayoutGroupWithRatioEditor : Editor {
